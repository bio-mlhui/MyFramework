...
all_configs = {
    ...
    'model': {
        ...
        'fusion_encoder':{
            ...
            'decoder':{
                'name': 'mask2former_video_all_instance_with_token_graph',
                'pre_norm':False,
                'mask_dim': 256,
...
config = f'[uni_fuse_q][joint_refer255_mlm5_mvm0][gradient]'
