...
class StableDiffusion(nn.Module):
    def __init__(self, 
                 configs,):
        super().__init__()
        sd_version = configs['sd_version'] # 2.1
        t_range = configs['t_range'] # [0.02, 0.98]
        vram_O = configs['vram_O']
        fp16 = configs['fp16']
        if sd_version == '2.1':
        ...
        logging.debug(f'loaded stable diffusion!')
    ...
    def forward_perpneg(self, text_embeddings, weights, pred_rgb, guidance_scale=100, as_latent=False, grad_scale=1,
                        save_guidance_path:Path=None):
