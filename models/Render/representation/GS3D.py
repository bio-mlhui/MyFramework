...
from data_schedule.render.scene_utils.mesh import Mesh
from data_schedule.render.scene_utils.mesh_utils import decimate_mesh, clean_mesh
...
class GaussianModel_meshfy(Trainer_GSModel):
