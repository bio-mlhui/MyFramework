...
import copy
from model.stego.ops.modules import MSDeformAttn
...
class MSDeformAttnTransformerEncoderOnly(nn.Module):
    ...
    def forward(self, srcs):
        ...
        # encoder
        memory = self.encoder(src_flatten, spatial_shapes, level_start_index, valid_ratios, None, mask_flatten)

        return memory # b hw c
