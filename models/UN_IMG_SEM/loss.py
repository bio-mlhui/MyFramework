...
class StegoLoss(nn.Module):
    ...
    def forward(self, model_input, model_output, model_pos_output=None, linear_output = None,
                cluster_output = None) \
...
class SupConLoss(nn.Module):
    ...
    def forward(self, modeloutput_z, modeloutput_s_pr=None, modeloutput_f=None,
        ...
        mask_neglect_base = torch.FloatTensor(split,batch_size).uniform_() < opt["model"]["rho"]
