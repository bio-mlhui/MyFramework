...
class Renderer(nn.Module):
    def __init__(self, opt):
        ...
        self.mesh = Mesh.load(self.opt['model']['mesh'], resize=False)
    ...
    def get_params(self):
        ...
        params = [
            {'params': self.raw_albedo, 'lr': self.opt['optim']['texture_lr']},
        ]

        if self.opt['optim']['train_geo']:
            params.append({'params': self.v_offsets, 'lr': self.opt['optim']['geom_lr']})
