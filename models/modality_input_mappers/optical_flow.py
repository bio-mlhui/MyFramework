...
class FlowNetS(nn.Module):
    def __init__(self, configs, flownet_method=""):
        super(FlowNetS, self).__init__()
        self.method = configs['model']['flownet_method']
        self.pool_stride = configs['model']['flownet_pool_stride']
        ...
        ckpt = torch.load(os.path.join(os.getenv('PT_PATH'), 'flownet/flownet.ckpt'), map_location='cpu')
