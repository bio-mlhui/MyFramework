...
class T5Encoder:
    def __init__(
        ...
        from_pretrained=text_encoder_configs.pop('from_pretrained', None)
        model_max_length=text_encoder_configs.pop('model_max_length', 120)
        device=text_encoder_configs.pop('device', 'cuda')
        dtype=text_encoder_configs.pop('dtype', torch.float)
        cache_dir=text_encoder_configs.pop('cache_dir', None)
    ...
    def shardformer_t5(self):
        ...
        from .t5_encoder import T5EncoderPolicy
