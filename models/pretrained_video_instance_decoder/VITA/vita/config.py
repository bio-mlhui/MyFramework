...
def add_vita_config(cfg):
    ...
    cfg.MODEL.VITA.FUSION = CN()
    cfg.MODEL.VITA.FUSION.NAME = 'no_fusion'
    cfg.MODEL.VITA.FUSION.NHEADS = 8
    cfg.MODEL.VITA.FUSION.D_MODEL = 256
    cfg.MODEL.VITA.FUSION.REL_SELF = 'after'
    cfg.MODEL.VITA.FUSION.DROPOUT = 0.0