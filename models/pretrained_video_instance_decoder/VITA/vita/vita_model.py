...
from models.pretrained_video_instance_decoder.VITA.mask2former.modeling.criterion import SetCriterion
from models.pretrained_video_instance_decoder.VITA.mask2former.modeling.matcher import HungarianMatcher
...
class Vita_2(nn.Module):
    ...
    def forward(self, batched_inputs, 
        ...
        image_tensors = batched_inputs.tensors.permute(1,0,2,3,4).flatten(0,1)
        images = image_tensors.chunk(chunks=len(image_tensors), dim=0)
...
from models.pretrained_video_instance_decoder.VITA.mask2former import add_maskformer2_config
