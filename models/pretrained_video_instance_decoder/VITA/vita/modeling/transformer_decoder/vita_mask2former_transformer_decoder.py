...
from models.pretrained_video_instance_decoder.VITA.mask2former.modeling.transformer_decoder.maskformer_transformer_decoder import TRANSFORMER_DECODER_REGISTRY
