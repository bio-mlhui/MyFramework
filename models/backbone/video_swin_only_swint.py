...
class VideoSwinTransformer(nn.Module):
    ...
    def __init__(self, configs):
        ...
        backbone_pretrained_path=os.path.join(os.getenv('PT_PATH'), configs['pt_path'])
    ...
    def forward(self, samples: NestedTensor):
        vid_frames = samples.tensors # b c t h w
        ...
        ret = {}
        orig_pad_mask = samples.mask # b t h w
        names = ['res2', 'res3', 'res4', 'res5']
        for name, l_out in zip(names, layer_outputs):
