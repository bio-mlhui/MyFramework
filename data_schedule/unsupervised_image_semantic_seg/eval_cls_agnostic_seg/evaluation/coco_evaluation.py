...
class COCOEvaluator(DatasetEvaluator):
    ...
    def evaluate(self, img_ids=None):
        ...
        if "instances" in predictions[0]:
            if 'AdaptiveImgIds' in self.dataset_name:
                all_img_ids = list(set([haosen['image_id'] for haosen in predictions]))
                self._eval_predictions(predictions, img_ids=all_img_ids)
            else:
