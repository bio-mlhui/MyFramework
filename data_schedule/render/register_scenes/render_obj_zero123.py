...
def set_camera_location(elevation, azimuth, distance):
    ...
    rot_quat = direction.to_track_quat('-Z', 'Y') # track, up, 某个物体track指向direction, Y和global Y对其
...
def get_3x4_RT_matrix_from_blender(cam):
    ...
    # return translation, rotation, and scale components of this matrix. 
    # (Vector, Quaternion, Vector), tuple of translation, rotation, and scale
...
def save_images(object_file: str) -> None:
    ...
    normalize_scene() # normalize the shape to box[-1,1]^3 in world space
