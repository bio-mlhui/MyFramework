...
def get_rendering_fn(view_camera=None,):
...
for scene_id in scene_ids:
    ...
    scene_call_fn = [GetSceneInfo(scene_dir=scene_dir, scene_id=scene_id, white_background=wbcg), 
                     GetSceneInfo(scene_dir=scene_dir, scene_id=scene_id, white_background=wbcg),  # 共享, 保证build是一样的
                     GetSceneInfo(scene_dir=scene_dir, scene_id=scene_id, white_background=wbcg)]
    ...
    for reg_name, reg_split, reg_condense, call_fn_idx, reg_split_tt, reg_mode in zip(register_names, register_split, register_condenses,
                                                                             register_call_fn_idx, register_split_traintest, register_mode):
