...
@MAPPER_REGISTRY.register()
class SingleView_3D_TrainerMapper_BlenderSameIntrin(Render_TrainMapper):
    """
    ...
    def _call(self, data_dict): 
        ...
        # [V_in, C, H, W]
        in_rendering_rgbs = F.interpolate(rgbs[:num_input_views].clone(), size=(self.input_view_size, self.input_view_size), mode='bilinear', align_corners=False)
        ...
        return {
            ...
            'outviews_dict':{
                ...
                'rendering_rgbs': F.interpolate(rgbs, 
                                                size=(self.output_view_size, self.output_view_size), 
                                                mode='bilinear', 
