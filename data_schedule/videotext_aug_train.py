...
_videotext_trainaug_entrypoints = {}

def register_videotext_trainaug(fn):
    aug_name = fn.__name__
    _videotext_trainaug_entrypoints[aug_name] = fn

    return fn

def videotext_trainaug_entrypoints(aug_name):
    try:
        return _videotext_trainaug_entrypoints[aug_name]
