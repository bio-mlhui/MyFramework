...
from .visha_utils import get_frames, get_frames_mask, SET_NAME_TO_DIR,\
      SET_NAME, SET_NAME_TO_NUM_VIDEOS, SET_NAME_TO_MODE, SET_NAME_TO_PREFIX, SET_NAME_TO_GT_TYPE

def visha_train(step_size, # none / int; 0, 6, 13, 19 ...
                  split_dataset_name,
                  video_ids,
                  video_to_frames):
...
def visha_evaluate(eval_video_ids,
                     split_dataset_name,
                     step_size,
                     video_to_frames):
...
for name in SET_NAME:
    ...
    if mode == 'train':
        train_meta = copy.deepcopy(visha_meta)
        ...
        for step_size in [1, 6, None]:
            ...
            DatasetCatalog.register(split_name, partial(visha_train,
                                                        video_ids=video_ids, 
        ...
        prefix = SET_NAME_TO_PREFIX[name]
        validate_meta = copy.deepcopy(visha_meta)
        ...
        for step_size in  [1, None,]:
            ...
            DatasetCatalog.register(split_name, partial(visha_evaluate,
